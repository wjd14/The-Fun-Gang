...
public static UpperIntake upperintake;
...
indexer = new Indexer();
    ...
    chooser.addOption("Go Backwards", new goBackwards(1));
    ...
    chooser.addOption("From In Front Of Target Zone Drive Forward And Shoot", new driveNShootAuto());
    chooser.addOption("Shoot ANd Then Go Back", new shootNDriveBackwards());
    ...
    public void teleopInit() {
        ...
        // continue until interrupted by another command, re
